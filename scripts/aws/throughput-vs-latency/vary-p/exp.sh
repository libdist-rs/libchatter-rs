...
W_List=(800 1000 2000 4000 7000 10000 20000 40000 60000 80000 100000 120000)
SW_List=(800 1000 2000 4000 7000 10000 20000 40000 60000 80000 100000 120000)
...
for w in ${SW_List[@]}; do
    echo "DP[Window]: $w"
    bash scripts/aws/throughput-vs-latency/exp.sh "scripts/aws/aws_ips.log" "testdata/b400-n3" $w "optsync"
    sleep 2
done >> $1/p0-optsync-run.log

for w in ${SW_List[@]}; do
    echo "DP[Window]: $w"
    bash scripts/aws/throughput-vs-latency/exp.sh "scripts/aws/aws_ips.log" "testdata/b400-n3-p128" $w "optsync"
    sleep 2
done >> $1/p128-optsync-run.log

for w in ${SW_List[@]}; do
    echo "DP[Window]: $w"
    bash scripts/aws/throughput-vs-latency/exp.sh "scripts/aws/aws_ips.log" "testdata/b400-n3-p1024" $w "optsync"
    sleep 2
...
# for w in ${W_List[@]}; do
#     echo "DP[Window]: $w"
#     bash scripts/aws/throughput-vs-latency/exp.sh "scripts/aws/aws_ips.log" "testdata/b400-n3-p128" $w "apollo" "normal"
#     sleep 2
# done >> $1/p128-apollo-normal-run.log

# for w in ${W_List[@]}; do
#     echo "DP[Window]: $w"
#     bash scripts/aws/throughput-vs-latency/exp.sh "scripts/aws/aws_ips.log" "testdata/b400-n3-p1024" $w "apollo" "normal"
#     sleep 2
